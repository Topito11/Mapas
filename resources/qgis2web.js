...
map.getView().fit([-6284302.355748, -4155511.956863, -6224596.900130, -4119820.994355], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Eventos de Reclusos de Modulo Máxima Seguridad</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (259 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'DARI-DGHC<br /><br />Reseña:<br />El presente mapa contiene los eventos extraídos del SGSP para cada uno de los reclusos del módulo de máxima seguridad de Santiago Vazquez, a los efectos de poder tener una idea de el sector en el que estos operaban antes de cer encarcelados';
            }
